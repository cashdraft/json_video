...
_STEM_TO_TARGET: dict[str, str] = {
    ...
    "distiller prompt": "stage:distiller",
    "distiller system promt": "stage:distiller",
    "distiller system prompt": "stage:distiller",
    "distiller user promt": "stage_user:distiller",
    "distiller user prompt": "stage_user:distiller",
    "author prompt": "stage:author",
    "author system promt": "stage:author",
    "author system prompt": "stage:author",
    "author user promt": "stage_user:author",
    "author user prompt": "stage_user:author",
    ...
    "animation planner prompt": "stage:animation_planner",
    "animation planner system promt": "stage:animation_planner",
    "animation planner system prompt": "stage:animation_planner",
    "animation planner user promt": "stage_user:animation_planner",
    "animation planner user prompt": "stage_user:animation_planner",
...
_TARGET_TO_FILENAME: dict[str, str] = {
    ...
    "stage:distiller": "Distiller System Promt.txt",
    "stage_user:distiller": "Distiller User Promt.txt",
    "stage:author": "Author System Promt.txt",
    "stage_user:author": "Author User Promt.txt",
    ...
    "stage:animation_planner": "Animation Planner System Promt.txt",
    "stage_user:animation_planner": "Animation Planner User Promt.txt",
