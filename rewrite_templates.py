...
Имена файлов внутри шаблона (без учёта регистра, расширение .txt):
  ...
  Analysis … Persona Editor Prompt (draft1: «Block Writer Prompt.txt», draft2: «Hook Audit Prompt.txt», flow_audit: «Flow Audit Prompt.txt», continuity_guard: «Continuity Guard Prompt.txt», retention_check: «Retention Check Prompt.txt», persona_style_guard: «Persona Style Guard Prompt.txt», voiceover_check: «Voiceover Check Prompt.txt», location_normalizer: «Location Normalizer Prompt.txt», continuity_editor: «Сontinuity Editor Prompt.txt», retention_editor: «Retention Editor Prompt.txt», hook_editor: «Hook Editor Prompt.txt», flow_editor: «Flow Editor Prompt.txt», persona_editor: «Persona Editor Prompt.txt»)
"""
...
_STEM_TO_TARGET: dict[str, str] = {
    ...
    "hook audit prompt": "stage:draft2",
    "hook audit system promt": "stage:draft2",
    "hook audit system prompt": "stage:draft2",
    "hook audit user promt": "stage_user:draft2",
    "hook audit user prompt": "stage_user:draft2",
    "flow audit prompt": "stage:flow_audit",
    "flow audit system promt": "stage:flow_audit",
    "flow audit system prompt": "stage:flow_audit",
    "flow audit user promt": "stage_user:flow_audit",
    "flow audit user prompt": "stage_user:flow_audit",
    "continuity guard prompt": "stage:continuity_guard",
    "continuity guard system promt": "stage:continuity_guard",
    "continuity guard system prompt": "stage:continuity_guard",
    "continuity guard user promt": "stage_user:continuity_guard",
    "continuity guard user prompt": "stage_user:continuity_guard",
    "retention check prompt": "stage:retention_check",
    "retention check system promt": "stage:retention_check",
    "retention check system prompt": "stage:retention_check",
    "retention check user promt": "stage_user:retention_check",
    "retention check user prompt": "stage_user:retention_check",
    "persona style guard prompt": "stage:persona_style_guard",
    "persona style guard system promt": "stage:persona_style_guard",
    "persona style guard system prompt": "stage:persona_style_guard",
    "persona style guard user promt": "stage_user:persona_style_guard",
    "persona style guard user prompt": "stage_user:persona_style_guard",
    "voiceover check prompt": "stage:voiceover_check",
    "voiceover check system promt": "stage:voiceover_check",
    "voiceover check system prompt": "stage:voiceover_check",
    "voiceover check user promt": "stage_user:voiceover_check",
    "voiceover check user prompt": "stage_user:voiceover_check",
    "location normalizer prompt": "stage:location_normalizer",
    "location normalizer system promt": "stage:location_normalizer",
    "location normalizer system prompt": "stage:location_normalizer",
    "location normalizer user promt": "stage_user:location_normalizer",
    "location normalizer user prompt": "stage_user:location_normalizer",
...
_TARGET_TO_FILENAME: dict[str, str] = {
    ...
    "stage:draft2": "Hook Audit System Promt.txt",
    "stage_user:draft2": "Hook Audit User Promt.txt",
    "stage:flow_audit": "Flow Audit System Promt.txt",
    "stage_user:flow_audit": "Flow Audit User Promt.txt",
    "stage:continuity_guard": "Continuity Guard System Promt.txt",
    "stage_user:continuity_guard": "Continuity Guard User Promt.txt",
    "stage:retention_check": "Retention Check System Promt.txt",
    "stage_user:retention_check": "Retention Check User Promt.txt",
    "stage:persona_style_guard": "Persona Style Guard System Promt.txt",
    "stage_user:persona_style_guard": "Persona Style Guard User Promt.txt",
    "stage:voiceover_check": "Voiceover Check System Promt.txt",
    "stage_user:voiceover_check": "Voiceover Check User Promt.txt",
    "stage:location_normalizer": "Location Normalizer System Promt.txt",
    "stage_user:location_normalizer": "Location Normalizer User Promt.txt",
